...
class BoxTests: XCTestCase {
    func testPointInside() {
        let box = Rect(a: SIMD2<Float>(0,0), b: SIMD2<Float>(0,100),c: SIMD2<Float>(100,100))
    ...
    func testPointInside2() {
        let b = Rect(a: SIMD2<Float>(11.93, 8.075), b: SIMD2<Float>(9.163, 11.93), c: SIMD2<Float>(10.84, 11.93))
        let point = SIMD2<Float>(11.0, 10.0)
        XCTAssert(b.isPointOnOrInside(point))
    }
    
    func testAngle() {
        let box = Rect(center: SIMD2<Float>(50,50),angle: 0, lengths: SIMD2<Float>(25,25))
    ...
    static var allTests = [
        ...
        ("testPointInside2",testPointInside2),
        ("testD",testD),
        ("testAngle",testAngle),
    ]
}
